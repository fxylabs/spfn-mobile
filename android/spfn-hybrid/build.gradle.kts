...
// SPFN Mobile — Android hybrid WebView adapter module.
...
description = "SPFN Android hybrid WebView adapter."

extra["spfnModuleDependsOn"] = listOf("spfn-core", "spfn-auth")
extra["spfnSwiftCounterpart"] = "SPFNHybrid"

android {
    namespace = "xyz.superfunction.spfn.hybrid"
