...
// SPFN Mobile — Android generated client module.
//
// Every Kotlin file under src/main/kotlin/xyz/superfunction/spfn/generated/ is produced
// by :contract-codegen from the bundle pinned in Contracts/upstream.lock.json. A
// hand-edited file is caught by rerunning the generator and diffing.
...
description = "SPFN Android generated client. Output of :contract-codegen from the pinned contract bundle."

extra["spfnModuleDependsOn"] = listOf("spfn-core")
extra["spfnSwiftCounterpart"] = "SPFNGenerated"

android {
    namespace = "xyz.superfunction.spfn.generated"
