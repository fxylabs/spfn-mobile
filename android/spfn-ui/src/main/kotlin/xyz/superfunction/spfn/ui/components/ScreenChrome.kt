...
// way to answer a question `Flow.leading` already answers.
...
/**
 * The leading control a flow's screens should draw, and what each of them does.
 *
 ...
 * this default and draws no leading control, which is the honest answer: nothing there
 * knows what going back would mean.
 */
internal val LocalScreenChrome: ProvidableCompositionLocal<ScreenChrome> =
    staticCompositionLocalOf { ScreenChrome(leading = ScreenLeading.None, onBack = {}, onClose = {}) };
