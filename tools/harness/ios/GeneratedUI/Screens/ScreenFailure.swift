...
public enum ScreenFailure
{
    ...
    public static func messageKey(_ envelope: SPFNErrorEnvelope) -> String
    {
        ...
        case callFailedCode:
            return networkKey
        case "InvalidSocialTokenError", "MfaVerificationFailedError", "PROOF_EXPIRED", "PROOF_INVALID", "PROOF_REPLAYED", "SESSION_REVOKED":
            return unauthorizedKey
        case "DeviceAuthNotFoundError", "DeviceLinkNotFoundError":
