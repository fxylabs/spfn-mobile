...
/// The `halfOne` screen, drawn out of SPFNUI's components.
@MainActor
public struct HalfOneView: View
{
    @State private var model: HalfOneModel

    public init(model: HalfOneModel)
    {
