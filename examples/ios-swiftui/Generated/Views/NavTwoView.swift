...
/// The `navTwo` screen, drawn out of SPFNUI's components.
@MainActor
public struct NavTwoView: View
{
    @State private var model: NavTwoModel

    public init(model: NavTwoModel)
    {
