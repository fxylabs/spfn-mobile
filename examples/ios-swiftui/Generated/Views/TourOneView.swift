...
/// The `tourOne` screen, drawn out of SPFNUI's components.
@MainActor
public struct TourOneView: View
{
    @State private var model: TourOneModel

    public init(model: TourOneModel)
    {
    ...
    {
        Screen(title: "Pushed, one of three", scroll: true)
        {
