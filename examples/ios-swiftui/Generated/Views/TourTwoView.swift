...
/// The `tourTwo` screen, drawn out of SPFNUI's components.
@MainActor
public struct TourTwoView: View
{
    @State private var model: TourTwoModel

    public init(model: TourTwoModel)
    {
    ...
    public var body: some View
    {
        Screen(
            ...
            trailing: AnyView(TextButton(title: "next", identifier: "tourTwo.next", onTap: { model.next() }).fixedSize()),
            scroll: true
        )
        {
