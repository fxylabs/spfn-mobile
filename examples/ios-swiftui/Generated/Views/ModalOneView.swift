...
/// The `modalOne` screen, drawn out of SPFNUI's components.
@MainActor
public struct ModalOneView: View
{
    @State private var model: ModalOneModel

    public init(model: ModalOneModel)
    {
    ...
    {
        Screen(title: "Over everything, one of two", scroll: true)
        {
