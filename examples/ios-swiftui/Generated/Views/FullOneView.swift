...
/// The `fullOne` screen, drawn out of SPFNUI's components.
@MainActor
public struct FullOneView: View
{
    @State private var model: FullOneModel

    public init(model: FullOneModel)
    {
    ...
    {
        Screen(title: "A sheet at full", scroll: true)
        {
