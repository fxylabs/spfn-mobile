...
public final class FormModel
{
    ...
    private let flow: Flow<KeyboardFormRoute>
    ...
    public var stack: [KeyboardFormRoute] { flow.stack }
    ...
    {
        flow.isPresented && flow.stack.last == KeyboardFormRoute.form
    }
}
